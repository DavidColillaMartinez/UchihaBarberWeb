...
| `openspec/specs/`, `openspec/changes/`                                                   | Specs consolidadas (`home-skeleton`, `products-page`, `site-navigation`, `home-cabecera`, `home-intro`); cambios del esqueleto, nav y cabecera-cruce archivados |
